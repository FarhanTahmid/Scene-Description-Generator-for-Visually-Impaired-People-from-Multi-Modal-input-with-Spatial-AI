...
class Generator(object):
    ...
    def __init__(self,
                 root_path="",
                 coco_vocab_path="generator_app/Data/processed/coco_vocab.pkl",
                 msrvtt_vocab_path="generator_app/Data/processed/msrvtt_vocab.pkl",
                 base_model='resnet152',
                 ic_model_path="generator_app/model/image_model/image_caption-model11-80-0.1312-5.0.pkl",
