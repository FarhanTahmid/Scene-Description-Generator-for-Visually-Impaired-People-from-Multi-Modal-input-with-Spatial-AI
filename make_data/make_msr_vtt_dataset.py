...
def main(args):
    ...
    if args.continue_converting:
        if os.path.isfile(args.interim_data_path + 'all_captions.csv'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--raw_data_path', type=str,
                        ...
                        default=os.environ['PROJECT_DIRECTORY']+'Data/raw/videodatainfo_2017_ustc.json')
    parser.add_argument('--interim_data_path', type=str,
                        help='Path to interim datafile',
                        default=os.environ['PROJECT_DIRECTORY']+'Data/interim/')
    parser.add_argument('--final_data_path', type=str,
                        help='Path to final datafile',
                        default=os.environ['PROJECT_DIRECTORY']+'Data/processed/')
