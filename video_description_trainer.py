# -*- coding: utf-8 -*-
"""Module for training the Video Captioner class."""
...
from software_utils.video_dataloader import get_video_dataloader, VideoDataset
...
def main(args):
    """
    Train video captioner with given parameters.
    ...
    # Get training and validation MSR-VTT dataloaders
    ...
    # Build Video Captioner model with the given parameters
    ...
    for epoch in range(starting_epoch, args.num_epochs):
        ...
        if epoch > 0 and epoch % args.val_interval == 0:
            ...
            for val_id, val_batch in enumerate(val_loader):
                ...
                if not args.beam_size:
                    preds, probs = captioner.predict(
                        vid_embeddings, True, beam_size=args.beam_size)
                    ...
                    preds = captioner.predict(
                        vid_embeddings, beam_size=args.beam_size)
                    val_loss += 5
            ...
            # Save model if better model is found
            if val_bleus[-1] > best_val_bleu:
                ...
                filename = os.path.join(
                    args.models_path, "video_caption-model{}-{}-{}-{}.pkl".
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_path', type=str, required=False,
                        ...
                        default=DIR_NAME+'Data/processed/msrvtt_vocab.pkl')
    parser.add_argument('--captions_path', type=str, required=False,
                        help='Path to MSR-VTT captions csv',
                        default=DIR_NAME+'Data/processed/msrvtt_captions.csv')
